...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{module_ui <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id) \{}
\NormalTok{  ns <-}\StringTok{ }\KeywordTok{NS}\NormalTok{(id)}

  \KeywordTok{tagList}\NormalTok{(}\KeywordTok{xxxOutput}\NormalTok{(}\KeywordTok{ns}\NormalTok{(outputId), ...))}
\NormalTok{\}}

\NormalTok{module_mod <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id, state) \{}
...
\NormalTok{  ... ...}
  \KeywordTok{module_mod}\NormalTok{(id, app_state)}
\NormalTok{  ... ...}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    ... ...}
      \KeywordTok{module_ui}\NormalTok{(id)}
\NormalTok{    ... ...}
\NormalTok{  )}
\NormalTok{)}
\end{Highlighting}
...
\hypertarget{event-observation-and-handling}{%
\subsection{Event observation and handling}\label{event-observation-and-handling}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{... ... }\CommentTok{## Within main server or module}
  \KeywordTok{observeEvent}\NormalTok{(eventExpr, handlerExpr, ...)}
\NormalTok{... ...}
\end{Highlighting}
\end{Shaded}
...
Calling the \texttt{reactivevalues} object \texttt{app\_state}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{module_mod <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id, }\DataTypeTok{state =}\NormalTok{ app_state) \{}
\NormalTok{  module <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(input, output, session) \{}
\NormalTok{    ... ...}
    \KeywordTok{observeEvent}\NormalTok{(eventExpr, \{}
\NormalTok{      state[[app_state_name]] <-}\StringTok{ }\NormalTok{... ...}
\NormalTok{    \})}
\NormalTok{    ... ...}
\NormalTok{  \}}
...
\hypertarget{implementation-of-interactive-linking}{%
\section{Implementation of interactive linking}\label{implementation-of-interactive-linking}}

\hypertarget{reactive-data-caching}{%
\subsection{Reactive data caching}\label{reactive-data-caching}}
...
\NormalTok{app_server <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(input, output, session) \{}
\NormalTok{  ... ...}
  \KeywordTok{observeEvent}\NormalTok{(input[[inputId]], \{}
\NormalTok{    ... ...}
    \KeywordTok{updateXxxInput}\NormalTok{(session, inputId, ...) }\CommentTok{## If needed}
\NormalTok{    app_state[[variable_name]] <-}\StringTok{ }\NormalTok{input[[inputId]]}
\NormalTok{  \})}
\NormalTok{  ... ...}
\NormalTok{\}}
\end{Highlighting}
...
\NormalTok{append_data <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, loc) \{}
  \KeywordTok{read_csv}\NormalTok{(...) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{... ... }\CommentTok{## Wrangling}
\NormalTok{\}}
...
\hypertarget{reactive-graphics-caching}{%
\subsection{Reactive graphics caching}\label{reactive-graphics-caching}}

Calling the \texttt{shiny::bindCache()} function:
...
\NormalTok{  module <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(input, output, session) \{}
\NormalTok{    ... ...}
\NormalTok{    output[[outputId]] <-}\StringTok{ }\KeywordTok{renderXxx}\NormalTok{(expr, ...) }\OperatorTok{%>%}
...
\hypertarget{server-side-interactive-linking}{%
\subsection{Server-side interactive linking}\label{server-side-interactive-linking}}
