...
\hypertarget{design-layout-and-philosophy}{%
\section{Design layout and philosophy}\label{design-layout-and-philosophy}}
...
\hypertarget{shiny-linking-and-reactivity}{%
\section{Shiny linking and reactivity}\label{shiny-linking-and-reactivity}}
...
This chapter, as a typical example, outlines the application of linking and reactivity on the user selection of monitor stations with interactive maps in the modularised application.
...
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/unnamed-chunk-10-2}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/unnamed-chunk-10-3}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/unnamed-chunk-10-4}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/unnamed-chunk-10-5}
