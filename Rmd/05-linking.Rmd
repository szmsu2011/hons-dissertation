...
Each of shiny modules consists of its independent UI and server, much similar to a miniature "shiny environment", called within the application UI and server. (TODO: The following code snippet presents a brief example of the auckland map module with key elements:)
