...
(ref:cal-demo-cap) A demonstration of a basic calendar heatmap with **Echarts.js** [@echarts] faceted (unaligned) by `year ~ month`. Each tile corresponds to the value of an observed day or aggregated sub-daily observations, whose exact date and day of the week are easily identifiable.
...
### Interactive graphics with Echarts JavaScript in R {#sec:int-graphics}
