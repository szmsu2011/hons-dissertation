...
## Data Quality and Cleaning {#sec:quality}

- Inconsistent time format "ymd hh:mm:ss", "ymd hh:mm" and "ymd"
- Negative, abnormal and missing pollutants
  - Negative treated as missing except for TEMP
  - Abnormal left untouched
- Duplicate records
  - First record is kept
- Implicit time gaps
  - Filled

- Remove index and key terms
...
```{r test, fig.pos = "ht", fig.align = "center", out.width = "100%"}
