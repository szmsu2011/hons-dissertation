...
xTab(
  ...
  caption.bottom = "Parameters available in raw data.\\\\\\textsuperscript{*} AQI-related ambient air pollutants",
  booktabs = TRUE,
...
aqi_cat_pal <- data.frame(
  ...
  "Colour (Hexadecimal Code)" = c(
    "\\colorbox[rgb]{0,.89,0}{\\textcolor[rgb]{0,.89,0}{**}} Green (\\#00E400)",
    "\\colorbox[rgb]{1,1,0}{\\textcolor[rgb]{1,1,0}{**}} Yellow (\\#FFFF00)",
    "\\colorbox[rgb]{1,.49,0}{\\textcolor[rgb]{1,.49,0}{**}} Orange (\\#FF7E00)",
    "\\colorbox[rgb]{1,0,0}{\\textcolor[rgb]{1,0,0}{**}} Red (\\#FF0000)",
    "\\colorbox[rgb]{.56,.25,.59}{\\textcolor[rgb]{.56,.25,.59}{**}} Purple (\\#8F3F97)",
    "\\colorbox[rgb]{.49,0,.14}{\\textcolor[rgb]{.49,0,.14}{**}} Maroon (\\#7E0023)"
  ),
  check.names = FALSE
)
